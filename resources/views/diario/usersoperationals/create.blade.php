                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Cadastrar um novo Operador</h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="email" name="email" class="form-control {{ isset($item->email) ? 'active' :null }}" required data-validation-required-message="Este Campo é obrigatório" value="{{ isset($item->email) ? $item->email : '' }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select class="select2 form-control" name="agency_id[]" multiple="multiple">
