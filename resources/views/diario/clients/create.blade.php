                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="initials" class="form-control {{ isset($item->initials) ? 'active' :null }}" required data-validation-required-message="Este Campo é obrigatório" value="{{ isset($item->initials) ? $item->initials : '' }}" autofocus>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="alias" class="form-control {{ isset($item->alias) ? 'active' :null }}" required data-validation-required-message="Este Campo é obrigatório" value="{{ isset($item->alias) ? $item->alias : '' }}" autofocus>
                                                    </div>
                                                </div>
                                            </div>
