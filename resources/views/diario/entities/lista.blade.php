<div class="card mb-0">
  ...
  <div class="card-content">
    <table id="tabela-item-lista" class="table table-fixed table-striped table-hover table-middle mb-0 zero-configuration">
      <thead>
        <tr>
          <th><a href="#" class="order" order="name" sort="ASC">Nome</a></th>
          <th><a href="#" class="order" order="state_id" sort="ASC">UF</a></th>
