			...
			<ul class="nav navbar-nav flex-row">
				...
				<li class="nav-item mr-auto">
					<a class="navbar-brand" href="index.html">
						<img class="brand-logo" alt="modern admin logo" src="{{ asset('img/logoImg.png') }}">
						<h3 class="brand-text"><img class="brand-logo" alt="modern admin logo" src="{{ asset('img/logoText.png') }}" style="width:115px"></h3>
					</a>
				</li>
			</ul>
		</div>
