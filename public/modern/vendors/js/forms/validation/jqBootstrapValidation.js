                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("minchecked") !== undefined) {
                            message = "Opções insuficientes; Mínimo de '" + $this.attr("minchecked") + "' obrigatório<!-- data-validation-minchecked-message to override -->";
                        ...
                        if ($this.attr("maxchecked") !== undefined) {
                            message = "Muitas opções marcadas; Máximo de '" + $this.attr("maxchecked") + "' obrigatoriamente<!-- data-validation-maxchecked-message to override -->";
        ...
        validatorTypes: {
            ...
            email: {
                ...
                init: function ($this, name) {
                    ...
                    var message = "Não é um email válido";
                    if ($this.data("validation" + name + "Message")) {
                        message = $this.data("validation" + name + "Message");
                    }
            ...
            max: {
                ...
                init: function ($this, name) {
                    ...
                    result.message = "Muito grande: Máximo de '" + result.max + "'";
                    if ($this.data("validation" + name + "Message")) {
