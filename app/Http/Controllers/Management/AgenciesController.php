...
class AgenciesController extends Controller
{
    ...
    protected $ctrl = array(
     ...
     public function __construct(AgencyService $agencyService, EntityService $entityService)
    {
    ...
    public function create()
    {
        ...
        return view('diario.'.$ctrl['route'].'.create', compact('ctrl', 'categories', 'entities'));
    }
    ...
    public function edit($id)
    {
        ...
        $categories = $this->service->categories();
        $entities = $this->entityService->index();
        return view('diario.'.$ctrl['route'].'.create', compact('ctrl', 'item', 'categories', 'entities'));
    }
