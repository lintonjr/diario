...
class LayoutPatternsController extends Controller
{
    /**
    ...
    protected $ctrl = array(
        "name"      => "Padrões de Layout",
        "prefix"    => "register",
        "route"     => "layoutpatterns",
        "title"     => "Padrões de Layout",
        "errors"    => ["error_all" => "Você não tem permissão!"]
    );

    public function __construct(LayoutPatternService $layoutPatternService)
    {
        $this->service = $layoutPatternService;
    }
